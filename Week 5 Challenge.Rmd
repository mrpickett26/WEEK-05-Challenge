...
# QQ plot and histograms 
 ...
 h2<-ggplot(z,aes(height)) + 
   geom_histogram(bins=30)
 h3<-ggplot(data=z, aes(age)) + 
   geom_histogram(bins=30)
 h4<-ggplot(data=z, aes(weight)) + 
   geom_histogram(bins=30)
 h5<-ggplot(data=z, aes(zombies_killed)) + 
   geom_histogram(bins=30)
 h6<-ggplot(data=z, aes(years_of_education)) + 
   geom_histogram(bins=30)

 library(cowplot)
conc<-plot_grid(h2,h3, h4,h5,h6,nrow=3)
